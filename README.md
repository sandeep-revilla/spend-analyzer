...
|  Fields:                                         |
|  email_event_id, hcp_id, hco_id,                 |
|  campaign_id, product_id, event_type,            |
...
|   - Extract country                              |
|   - Extract product_id                           |
|   - Extract event_type (SENT/OPENED/BOUNCED)     |
|                                                  |
...
|               Shuffle & Sort Phase               |
|                                                  |
|  - Hadoop groups all identical keys together     |
|                                                  |
|  Example Grouping:                               |
|   (India|PROD005|OPENED)  -> [1,1,1,1,...]       |
|   (India|PROD005|SENT)    -> [1,1,1,1,...]       |
